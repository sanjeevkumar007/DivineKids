        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDefaultForNewUsers = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedDate = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false),
                    RequiresShipping = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
